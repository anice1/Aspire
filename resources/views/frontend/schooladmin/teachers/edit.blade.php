                        ...
                        <form class="new-added-form" method='GET' action="{{route('teachers.update', $teacher->id)}}" enctype='multipart/form-data'>
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" name='firstname' placeholder="" class="form-control" value='{{$teacher->user->firstname}}'>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Last Name *</label>
                                    <input type="text" name='lastname' placeholder="" class="form-control" value='{{$teacher->user->lastname}}'>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Gender *</label>
                                    <select class="select2 select2-hidden-accessible" name='gender' data-select2-id="1" tabindex="-1" aria-hidden="true" required>
                                        <option data-select2-id="3">{{$teacher->gender}}</option>
                                        <option value="" data-select2-id="3">Please Select Gender *</option>
                                        <option>Male</option>
                                        <option>Female</option>
                                        <option>Others</option>
                                    </select>
                                    <span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-nrwp-container"><span class="select2-selection__rendered" id="select2-nrwp-container" role="textbox" aria-readonly="true" title="Please Select Gender *">Please Select Gender *</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Date Of Birth *</label>
                                    <input type="date" name='dob' placeholder="dd/mm/yyyy" class="form-control air-datepicker" value='{{$teacher->dob}}'>
                                    <i class="far fa-calendar-alt"></i>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Blood Group *</label>
                                    <select class="select2 select2-hidden-accessible" name='blood_group' data-select2-id="4" tabindex="-1" aria-hidden="true">
                                        <option data-select2-id="6">{{$teacher->blood_group}}</option>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2 select2-hidden-accessible" name='religion' data-select2-id="7" tabindex="-1" aria-hidden="true">
                                        <option data-select2-id="9">{{$teacher->religion}}</option>
                                        <option>Islam</option>
                                        <option>Hindu</option>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2 select2-hidden-accessible" name='class' data-select2-id="10" tabindex="-1" aria-hidden="true">
                                        <option data-select2-id="12">{{$teacher->class}}</option>
